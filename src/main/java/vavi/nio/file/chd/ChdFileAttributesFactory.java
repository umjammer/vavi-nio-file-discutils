...
/**
 * ChdFileAttributesFactory.
 *
 * @author <a href="mailto:umjammer@gmail.com">Naohide Sano</a> (umjammer)
 * @version 0.00 2025/09/30 umjammer initial version <br>
 */
public final class ChdFileAttributesFactory extends ExtendedFileAttributesFactory {

    public ChdFileAttributesFactory() {
        setMetadataClass(Entity.class);
        addImplementation("basic", ChdBasicFileAttributesProvider.class);
    }
}
