...
public class BlockGroup implements IByteArraySerializable {
    ...
    public int readFrom(byte[] buffer, int offset) {
        ...
        FreeBlocksCount = (short) EndianUtilities.toUInt16LittleEndian(buffer, offset + 12);
        FreeInodesCount = (short) EndianUtilities.toUInt16LittleEndian(buffer, offset + 14);
        UsedDirsCount = (short) EndianUtilities.toUInt16LittleEndian(buffer, offset + 16);
        return DescriptorSize;
    }
